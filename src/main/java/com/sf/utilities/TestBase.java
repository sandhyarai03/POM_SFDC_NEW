...
import com.sf.listeners.ExtentManager;

@Listeners(com.sf.listeners.TestListener.class)
public class TestBase {
	...
	public void TriggerDependencies() throws Exception {
		...
		oCommUtil.loadPropertyFiles(System.getProperty("user.dir") + "/src/main/java/com/sf/properties/config.properties");
		oCommUtil.loadLog4jProperty(System.getProperty("user.dir") + "/src/main/java/com/sf/properties/log4j.properties");
		oCommUtil.loadPropertyFiles(System.getProperty("user.dir") + "/src/main/java/com/sf/properties/testdata.properties");
		//oCommUtil.loadPropertyFiles(System.getProperty("user.dir") + "/src/main/java/com/sf/properties/stringData.properties");
